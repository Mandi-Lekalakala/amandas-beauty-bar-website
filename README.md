...
A responsive multi-page beauty salon mobile first website built with HTML, CSS, and JavaScript. Created for a real client to give their beauty business a professional online presence with a fully functional booking experience.
...
![About Section](screenshots/amanda-about.png)
![Booking Form](screenshots/booking-form.png)
![Booking Confirmation](screenshots/confirm-booking.png)
